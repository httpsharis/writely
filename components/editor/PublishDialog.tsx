      ...
      <div className="relative z-10 w-full max-w-md border-[3px] border-black bg-white shadow-[6px_6px_0px_black]">
        ...
        <div className="p-5">
          ...
          <div className="mb-5 flex items-center gap-3">
            ...
            >
              <Globe size={18} className={isPublished ? 'text-black' : 'text-gray-500'} />
            </div>
            <div>
          ...
          <div className="mb-4 border-2 border-gray-200 bg-gray-50 px-3 py-2.5 font-mono text-[10px]">
            <span className="font-bold">{publishedChapterCount}</span> chapter
            {publishedChapterCount !== 1 ? 's' : ''} marked as published
            {publishedChapterCount === 0 && !isPublished && (
              <div className="mt-1 flex items-center gap-1 text-secondary">
                <AlertTriangle size={10} />
                Mark chapters as &ldquo;published&rdquo; in the sidebar first
              </div>
            )}
          </div>
          ...
          <button
            ...
            className={cn(
              ...
              'disabled:cursor-not-allowed disabled:translate-x-0 disabled:translate-y-0 disabled:opacity-50 disabled:shadow-none',
              isPublished
