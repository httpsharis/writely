...
import { useSearchDocumentsQuery } from "@/redux/features/search/searchApi";
...
export function CommandPalette() {
    ...
    const { data: searchResults, isLoading } = useSearchDocumentsQuery(debouncedSearch, { skip: debouncedSearch.length < 2 });
