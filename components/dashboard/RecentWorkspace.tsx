...
export function RecentWorkspace({
  ...
  // Instead of turning the whole card into a rainbow, we use a strict 2px left-border
  // on the icon container. This provides instant visual sorting without breaking the minimalist theme.
        ...
        {isLoading
          ...
          : files.map((file) => {
              ...
              return (
                <button
                  key={file.id}
                  // The Negative Margin Hover Trick keeps the text aligned but lets the hover state bleed outward
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      {/* Increased contrast via font-bold to pass WCAG AA standards as requested in the critique */}
